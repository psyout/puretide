...
export default function GlobalError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
	...
	return (
		<html lang='en'>
			<body className='m-0 font-sans bg-gradient-to-br from-mineral-white via-deep-tidal-teal-50 to-eucalyptus-50 min-h-screen flex items-center justify-center'>
				<div className='max-w-lg mx-6 bg-eucalyptus-100/60 backdrop-blur-sm rounded-lg ui-border p-8 shadow-lg text-center'>
