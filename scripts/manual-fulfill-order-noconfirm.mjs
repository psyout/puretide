...
// Script to manually mark an order as paid and trigger fulfillment (no confirmation)
...
if (!orderNumber) {
	console.error('Usage: node scripts/manual-fulfill-order-noconfirm.mjs <orderNumber>');
	process.exit(1);
}
...
async function main() {
	...
	try {
		...
		console.log('🔄 Marking order as paid and triggering fulfillment...\n');
